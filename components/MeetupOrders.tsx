...
import { getUserMeetupOrders } from "@/controller/order.controller";
...
const MeetupOrders = () => {
    const { status, data } = useQuery({
        queryKey: ['user-meetup-orders'],
        queryFn: getUserMeetupOrders
    });
